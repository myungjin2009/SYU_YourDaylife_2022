...
public class TodoRecyclerAdapter extends RecyclerView.Adapter<TodoRecyclerAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull final TodoRecyclerAdapter.ViewHolder holder, int position)
    {
        ...
        switch (data.getPriority()) {
            case 0:
                priority = "높음!";
                holder.mainView.setBackgroundColor(Color.parseColor("#ffc0cb")); //옅은 자홍색
                break;
            case 1:
                priority = "중간";
                holder.mainView.setBackgroundColor(Color.parseColor("#fecdc1")); //옅은 노랑색
                break;
            case 2:
                priority = "낮음";
                holder.mainView.setBackgroundColor(Color.parseColor("#a27c82"));
                break;
        }
